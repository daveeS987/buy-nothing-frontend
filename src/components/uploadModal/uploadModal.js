  ...
  return (
    <>
      <Modal
        ...
        onClose={handleClose}
        trigger={
          <Button basic color="teal" onClick={handleShow}>
            Create New Post
          </Button>
        }
      >
          ...
          <form onSubmit={uploadHandler}>
            <div>
              <div>
                <div>
                  {image ? (
                    ...
                    <img
                      ...
                      alt="preuploadimage"
                      src={
                        'https://via.placeholder.com/300x300?text=Upload+Image'
                      }
                    />
                  )}
                </div>
                ...
                <label htmlFor="image">{image ? fileData() : ''}</label>
              </div>
            </div>
            {!isUploaded ? (
              <button
            ...
            <div>{image ? uploadComplete() : ''}</div>

            {error ? (
              <div> Some error occured uploading the file{`${error}`}</div>
            ) : null}
          </form>
        </Modal.Content>
        ...
        <Modal.Actions>
          <If condition={!isUploaded}>
            <Then>
              <Button>Please Upload Image</Button>
            </Then>
            <Else>
